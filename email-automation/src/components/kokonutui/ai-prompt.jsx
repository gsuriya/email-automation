...
export default function AI_Prompt() {
  ...
  return (
    <div className="w-full flex-1 flex flex-col">
      <div className="rounded-xl border border-border bg-black/5 p-1.5 pt-4 dark:bg-white/5 flex-1 flex flex-col">
        ...
        <div className="flex-1 flex flex-col min-h-0">
          <Textarea
            className={cn(
              "flex-1 w-full resize-none rounded-xl rounded-b-none border-none bg-black/5 px-4 py-3 placeholder:text-black/70 focus-visible:ring-0 focus-visible:ring-offset-0 dark:bg-white/5 dark:text-white dark:placeholder:text-white/70",
          ...
          <div className="relative flex h-14 shrink-0 items-center rounded-b-xl bg-black/5 dark:bg-white/5">
            <div
